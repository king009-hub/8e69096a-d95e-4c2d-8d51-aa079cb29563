...
import { BAR_CATEGORIES, getStationForCategory } from '@/components/hotel/KOTPrint';
...
export default function BarDisplay() {
  ...
  const readyOrders = barOrders.filter(o => o.status === 'ready');
      ...
      <div className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden">
        ...
        <ScrollArea className="flex-1">
          <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    ...
                    <CardContent className="pt-3 px-4 pb-3">
                      ...
                      <div className="flex gap-2">
                        {order.status === 'pending' && (
                          <>
                            <Button className="flex-1" onClick={() => handleStatusChange(order.id, 'preparing')}>
                        ...
                        {order.status === 'ready' && (
                          <Button className="flex-1" variant="outline" onClick={() => handleStatusChange(order.id, 'served')}>
            ...
            {barOrders.filter(o => ['pending', 'preparing', 'ready'].includes(o.status)).length === 0 && (
